// NNUE評価関数の学習クラステンプレートのAffineTransformSparseInput用特殊化

#ifndef CLASSIC_NNUE_TRAINER_AFFINE_TRANSFORM_SPARSE_INPUT_H
#define CLASSIC_NNUE_TRAINER_AFFINE_TRANSFORM_SPARSE_INPUT_H
...
class Trainer<Layers::AffineTransformSparseInput<PreviousLayer, OutputDimensions>> {
 private:
  // 学習対象の層の型
  using LayerType = Layers::AffineTransformSparseInput<PreviousLayer, OutputDimensions>;
