...
namespace Eval
{
	...
	static const u64 KPPP_KING_SQ = EVAL_KPPPT * 5 / 9;
#else
	static const u64 KPPP_KING_SQ = EVAL_KPPPT;
#endif
	...
	extern ValueKppp(*kppp_)[1] /* [KPPP_KING_SQ][kppp_triangle_fe_end] */;
...
// 前提条件) i > j > k
#define kppp_ksq_pcpcpc(king,i,j,k) (kppp[(u64)king * kppp_triangle_fe_end + u64(i)*(u64(i) - 1) * (u64(i) - 2) / 6 + u64(j)*(u64(j) - 1) / 2 + u64(k)])
