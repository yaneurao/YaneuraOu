#ifndef _EVALUATE_KPPP_KKPT_H_
#define _EVALUATE_KPPP_KKPT_H_
...
namespace Eval
{
	...
	static const int KPPP_KING_SQ = EVAL_KPPP_KKPT * 5 / 9;
#else
	static const int KPPP_KING_SQ = EVAL_KPPP_KKPT;
#endif
	// 先手玉がこの段以下にあるなら、KPPPの計算をする。
	static const int KPPP_KING_RANK = ((int)RANK_9 - EVAL_KPPP_KKPT / 9 + 1);
