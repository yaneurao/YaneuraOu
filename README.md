...
Hyperopt等を用いて各種ハイパーパラメーターの調整の自動化を行ない自動調整します。
Apery(WCSC26)の評価関数バイナリを読み込めるようにします。(R3400程度の予定)
...
#　俺の作業メモ(2016/06/18 24:00現在)

※　括弧のなかの+Rは、自己対局時の勝率から計算されるもので、0.5手延長などは顕著に勝率が上がりますが、自己対局以外では効果に乏しいです。

- [x] 2016/06/18・長い持ち時間での勝率upのためのチューニング各種(長い持ち時間においてR+120)
