...
やねうら王twigはやねうら王classicの評価関数をAperyTwig(Apery 電王トーナメント2015バージョン)に変更して、Ponderの処理、思考時間制御などを追加した思考エンジンです。(R3250程度を予定)
...
・やねうら王twigの遊び方
    ...
    YaneuraOu-twig.exe      : やねうら王twig本体
    YaneuraOu-twig_ja.txt   : これを用いると思考エンジンの設定項目の表示が日本語化される。
